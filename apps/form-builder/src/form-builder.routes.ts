...
import { createTemplateSchema, templateIdParamSchema, templateParamSchema } from "@libs/dto/form-builder.dto";
...
router.post("/submit/:templateId",validate(templateIdParamSchema,"params"),controller.submitForm.bind(controller));
